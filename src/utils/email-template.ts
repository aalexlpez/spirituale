     ...
     <tr>
      <td valign="top" style="padding:0;Margin:0">
       ...
       <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important">
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" align="center" class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;background-repeat:no-repeat;width:600px;background-image:url(https://fuhukcl.stripocdn.email/content/guids/CABINET_6306d45fd9ea3b681ebe3a603101f0275312c7c136d6957f7ed43fa4b22490f7/images/frame_375_tsP.png);background-position:center top" background="https://fuhukcl.stripocdn.email/content/guids/CABINET_6306d45fd9ea3b681ebe3a603101f0275312c7c136d6957f7ed43fa4b22490f7/images/frame_375_tsP.png" role="none">
             <tr>
                 ...
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:600px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:10px" role="presentation">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"><h2 style="Margin:0;font-family:'Barlow Condensed', Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:normal;line-height:33.6px;color:#d2c7ff"><span style="color:#ff99dc">Hola</span> ${name},</h2><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:24px;letter-spacing:0;color:#d2c7ff;font-size:16px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:24px;letter-spacing:0;color:#d2c7ff;font-size:16px;text-align:justify">Felicitaciones por inscribirte en el evento online gratuito: 3 PASOS PARA REVELAR TU ABUNDANCIA CONSCIENTE🔮🧿<br><br>El 22 de marzo tendremos este entrenamiento exclusivo, que estoy segura, te va a proporcionar todas las herramientas necesarias para incorporar hábitos &nbsp;espirituales sencillos y prácticos para activar tu Abundancia Consciente.<br><br>Te revelaré un paso a paso amable y sencillo para incluir la espiritualidad en tu día a día y así conectar con tu magia creadora<br><br>Me emociona saber que sientes gran interés por este tema y que deseas una transformación para tu vida<br><br>Para asegurar tu participación en 3 PASOS PARA REVELAR TU ABUNDANCIA CONSCIENTE🔮 es necesario que des un paso … Únete al grupo exclusivo de WhatsApp.<br><br>En el grupo compartiremos materiales exclusivos y el enlace a la clase.<br><br>Haz clic en el botón y únete al grupo.<br><br><a target="_blank" href="https://chat.whatsapp.com/L730CWaUBL1JgRhBqVHpfI" style="color: #ff99dc">¡UNIRME AL GRUPO!</a></strong><br>¡Así garantizas tu lugar en el evento!<br><br>Ale</p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:15px;padding-bottom:15px;font-size:0">
                       <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td valign="top" align="center" class="es-m-p0r es-m-p20b" style="padding:0;Margin:0;width:600px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-bottom:20px"><h1 class="es-m-txt-c" style="Margin:0;font-family:'Barlow Condensed', Arial, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:normal;line-height:55.2px;color:#ff99dc"><span style="color:#d2c7ff">Asegúrate de estar al día con nuestras </span><strong style="color:#ff99dc">novedades</strong><span style="color:#d2c7ff">... 👀</span>&nbsp;</h1></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             </tr>
              <tr href="Instagram.com/spiritu.alee" style="cursor: pointer">
             ...
             <tr href="https://wa.me/message/53SYRQ6PEQEBP1" style="cursor: pointer"> 
              <td align="left" bgcolor="#D2C7FF" class="es-m-p20" style="padding:40px;Margin:0;background-color:#D2C7FF;border-radius:10px"><!--[if mso]><table style="width:520px" cellpadding="0" cellspacing="0"><tr><td style="width:90px" valign="top"><![endif]-->
               <table cellpadding="0" cellspacing="0" align="left" class="es-left" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                 <tr>
                  <td align="center" valign="top" class="es-m-p20b" style="padding:0;Margin:0;width:90px">
    ...
    <a href="https://www.canva.com/design/DAGgzyxscjI/_OnzqK8Y_AuCTvIy789Y7g/edit?utm_content=DAGgzyxscjI&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="display: block; text-decoration: none; color: inherit;">
      ...
      <table cellpadding="0" cellspacing="0" align="right" class="es-right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
       ...
       <table cellpadding="0" cellspacing="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important">
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table bgcolor="#102b3f" align="center" cellpadding="0" cellspacing="0" class="es-content-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#102B3F;width:600px">
             <tr>
              <td align="left" class="es-m-p20r es-m-p20l" style="padding:0;Margin:0;padding-top:30px;padding-bottom:30px">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table bgcolor="#f7fff7" align="center" cellpadding="0" cellspacing="0" class="es-footer-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#102B3F;width:600px">
             <tr>
              <td align="left" style="Margin:0;padding-bottom:40px;padding-right:20px;padding-left:20px;padding-top:40px">
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
