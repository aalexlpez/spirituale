                            ...
                            <li>
                                ...
                                >
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="font-bold text-themeNavy bg-themeNeon px-8 py-3 rounded-full transition-colors duration-300 hover:bg-themeNavy hover:text-themeNeon border-[3px] border-themeNeon disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                ...
                <Container className="!px-0 md:hidden">
                                ...
                                <li>
                                    ...
                                    >
                                        <button
                                            onClick={handleP2PValidation}
                                            disabled={isLoading}
                                            className="font-bold text-themeNavy bg-themeNeon px-8 py-3 rounded-full transition-colors duration-300 hover:bg-themeNavy hover:text-themeNeon disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            {isLoading ? 'Procesando...' : '¡Únete Ya!'}
                                        </button>
                                    </motion.div>
                    ...
                    >
                        <button
                            onClick={handleP2PValidation}
                            disabled={isLoading}
                            className="font-bold text-themeNavy bg-themeNeon px-6 py-3 rounded-full shadow-lg transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isLoading ? 'Procesando...' : '¡Únete Ya!'}
                        </button>
                    </motion.div>
